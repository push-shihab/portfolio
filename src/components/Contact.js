...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="py-24 bg-card/30 border-t border-border-color"
    >
        ...
        >
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            >
              ...
              <div>
                ...
                <div className="text-foreground font-medium break-all sm:break-normal">
                  shihabfamily539@gmail.com
                </div>
              </div>
            </motion.a>
          ...
          <motion.div variants={itemVariants} className="lg:col-span-3">
            <form
              ...
              className="flex flex-col gap-6 p-8 rounded-3xl bg-card border border-border-color shadow-sm"
            >
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    className="px-4 py-3.5 rounded-xl bg-background border border-border-color focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent text-foreground transition-all"
                  />
                </div>
                <div className="flex flex-col gap-2">
                  <label
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  ...
                  className="px-4 py-3.5 rounded-xl bg-background border border-border-color focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent text-foreground resize-none transition-all"
                ></textarea>
              </div>
